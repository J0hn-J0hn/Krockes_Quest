...
sky_surf = pygame.image.load("Sprites\\Enviroment\\sky.jpg").convert()
ground_surf = pygame.image.load("Sprites\\Enviroment\\ground2.jpg").convert()

carrot_surf = pygame.image.load("Sprites\\Objects\\morot_long.png").convert_alpha()
carrot_rect = pygame.Rect(screen_width,200,20,100)

meat_height = 200
meat_surf = pygame.image.load("Sprites\\Objects\\meat.png").convert_alpha()
meat_rect = meat_surf.get_rect(midbottom = (screen_width,200))

# Tar in och ändrar stl på alla sprites för att springa
player_walk_1 = pygame.image.load("Sprites\\Player\\Hakan_run\\run_1.png").convert_alpha()
player_walk_1 = pygame.transform.scale(player_walk_1, (60, 60))
player_walk_2 = pygame.image.load("Sprites\\Player\\Hakan_run\\run_2.png").convert_alpha()
player_walk_2 = pygame.transform.scale(player_walk_2, (60, 60))
player_walk_3 = pygame.image.load("Sprites\\Player\\Hakan_run\\run_3.png").convert_alpha()
player_walk_3 = pygame.transform.scale(player_walk_3, (60, 60))
player_walk_4 = pygame.image.load("Sprites\\Player\\Hakan_run\\run_4.png").convert_alpha()
player_walk_4 = pygame.transform.scale(player_walk_4, (60, 60))
player_walk_5 = pygame.image.load("Sprites\\Player\\Hakan_run\\run_5.png").convert_alpha()
player_walk_5 = pygame.transform.scale(player_walk_5, (60, 60))
player_walk_6 = pygame.image.load("Sprites\\Player\\Hakan_run\\run_6.png").convert_alpha()
player_walk_6 = pygame.transform.scale(player_walk_6, (60, 60))
player_walk_7 = pygame.image.load("Sprites\\Player\\Hakan_run\\run_7.png").convert_alpha()
player_walk_7 = pygame.transform.scale(player_walk_7, (60, 60))
player_walk_8 = pygame.image.load("Sprites\\Player\\Hakan_run\\run_8.png").convert_alpha()
player_walk_8 = pygame.transform.scale(player_walk_8, (60, 60))
player_walk_9 = pygame.image.load("Sprites\\Player\\Hakan_run\\run_9.png").convert_alpha()
player_walk_9 = pygame.transform.scale(player_walk_9, (60, 60))
player_walk_10 = pygame.image.load("Sprites\\Player\\Hakan_run\\run_10.png").convert_alpha()
player_walk_10 = pygame.transform.scale(player_walk_10, (60, 60))
player_walk_11 = pygame.image.load("Sprites\\Player\\Hakan_run\\run_11.png").convert_alpha()
player_walk_11 = pygame.transform.scale(player_walk_11, (60, 60))
player_walk_12 = pygame.image.load("Sprites\\Player\\Hakan_run\\run_12.png").convert_alpha()
...
player_jump = pygame.image.load("Sprites\\Player\\hopp_1.png").convert_alpha()
...
while True:
    ...
    for event in pygame.event.get():
        ...
        if game_active: # Denna körs när ett spel körs
            ...
            # Kontrollera efter input, specifikt spacebar (K_SPACE)
        ...
        else: # Denna körs när ett spel är över
            # Tryck spacebar för nytt spel, nollställ poäng
            if event.type == pygame.KEYDOWN and event.key == pygame.K_SPACE:
